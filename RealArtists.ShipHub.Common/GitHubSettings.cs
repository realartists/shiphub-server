namespace RealArtists.ShipHub.Common {
  ...
  public static class GitHubSettings {
    ...
    public static GitHubClient CreateUserClient(User user, Guid correlationId) {
      if (user == null) {
    ...
    public static GitHubClient CreateUserClient(string accessToken, string userInfo, Guid correlationId, GitHubRateLimit rateLimit = null) {
